...
def main() -> int:
    ...
    environment = {**os.environ, "PYTHONPATH": str(repo / "backend"), "PYTHONIOENCODING": "utf-8"}
    ...
    summary = {
        ...
        "versions": {name: version(name) for name in ("SLiCAP", "sfg-prototype", "PySide6", "sympy", "numpy")},
